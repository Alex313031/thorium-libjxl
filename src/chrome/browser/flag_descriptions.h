...
inline constexpr char kEnableJXLName[] =
    "Enable/Disable JXL image format";
inline constexpr char kEnableJXLDescription[] =
    "Enable/Disable image decoding support for the JPEG XL image format. "
    "(Default: Enabled) Thorium Flag.";
